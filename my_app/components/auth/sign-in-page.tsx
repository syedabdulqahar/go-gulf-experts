...
function AuthPanel() {
  ...
  const { signIn, signInWithGoogle, signInWithLinkedIn, isDemoMode } = useAuth();
    ...
    try {
      ...
      setAuthError(
        errorCode === "auth/operation-not-allowed"
          ? "LinkedIn sign-in is not enabled in Firebase. Enable the LinkedIn OIDC provider in Firebase Console."
    ...
    <div className="najm-auth-panel">
      <div className="auth-container">
        ...
        {isDemoMode && (
          ...
          >
            ℹ️ Demo Firebase Mode Active. Credentials set in .env.local
          </div>
        )}
        ...
        <div className="social-grid">
          <button type="button" className="social-btn" onClick={handleLinkedInSignIn} disabled={isSubmitting}>
            <span className="linkedin-icon">in</span>
            <span>LinkedIn</span>
          </button>
          <button type="button" className="social-btn" onClick={handleGoogleSignIn} disabled={isSubmitting}>
            <GoogleIcon />
            <span>Google</span>
          </button>
        </div>
